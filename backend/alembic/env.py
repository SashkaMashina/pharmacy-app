...
from app.core.config import settings  # Правильный импорт настроек
from app.models.base import Base      # Базовый класс моделей
from app.models.admin import Admin          # Импортируй модель, чтобы Alembic её "увидел"
...
# Указываем, где искать метаданные моделей
